...
Sutto currently supports **GNOME Shell 46**.

## How do I report a bug?

Please open an issue on the [GitHub Issues](https://github.com/x7c1/sutto/issues) page. Include your GNOME Shell version and steps to reproduce the problem.

## How do I set a keyboard shortcut?

See the [Usage guide](/usage#keyboard-shortcut-optional) for step-by-step instructions on configuring a keyboard shortcut.
